...
export default class Burkesoutlet extends Store {
    ...
    async availibilityCalculate(): Promise<void> {
        try {
            ...
            const availability = await this.page.$eval('div.holder-tighter > div.info-box.ribbon.black', elem => elem.textContent)
    ...
    async priceCalculate(): Promise<void> {
        try {
            ...
            const price = textToNumber(
                await this.page.$eval('span#price', elem => elem.textContent)
            )
