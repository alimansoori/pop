...
export default class Joann extends Store {
    ...
    async availibilityCalculate(): Promise<void> {
        try {
            ...
            const availability = await this.page.$eval('[class="product-availability__item"]', elem => elem.textContent)
    ...
    async priceCalculate(): Promise<void> {
        try {
            ...
            const price = textToNumber(
                await this.page.$eval('span[data-product-container="sales-price"]', elem => elem.getAttribute("content"))
            )
