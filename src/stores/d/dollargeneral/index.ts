...
export default class Dollargeneral extends Store {
    ...
    async availibilityCalculate(): Promise<void> {
        try {
            ...
            const availability = await this.page.$eval('span[class="product__online-stock"]', elem => elem.textContent)
    ...
    async priceCalculate(): Promise<void> {
        try {
            ...
            const price = textToNumber(
                await this.page.$eval('span[class="product-price"]', elem => elem.textContent)
            )
